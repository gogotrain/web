<template>
  <div class="sign">  
    ...
    <Form ref="formInline" :model="form" :rules="ruleInline" inline>
      <!-- 個人和組織按鈕 -->
     <Form-item>
      <Button type="primary" size="large" >個人</Button>
     </Form-item>
     <Form-item>
      <Button type="primary" size="large" @click="toperson">組織</Button>
     </Form-item>
      <br />
      <!-- 帳號輸入 -->
      <Form-item prop="user">
      ...
      <!-- 登入按鈕 -->
      <Form-item>
      <Button type="success" size="large" style="position:relative; top:10px"  @click="toregister">個人註冊</Button>
      </Form-item>
      <Form-item>
